...
<section id="primary" class="content-area">
	<main id="main" class="site-main container">
		<div class="error-404 not-found">
			<h1><?php echo esc_html__( 'Oops!', 'newslist' ) ?></h1>
			<p><?php echo esc_html__( 'This page doesn\'t seem to exist.', 'newslist' ) ?></p>
			<svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1366 840" style="enable-background:new 0 0 1366 768;" xml:space="preserve">
				<style type="text/css">
					.st0 {
						fill: #002E4F;
					}
			...
			<div>
				<p><?php esc_html_e( 'It looks like the link pointing here was faulty. Maybe try searching?', 'newslist' ) ?></p>
				<?php get_search_form(); ?>
				<a href="<?php echo esc_url(home_url('/')) ?>" class="<?php echo esc_attr( Newslist_Helper::with_prefix( 'btn-primary' ) ); ?>">
					<?php echo esc_html__( 'Goto Homepage', 'newslist' ) ?>
