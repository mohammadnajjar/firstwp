...
class Newslist_Customizer_Loader extends Newslist_Helper {
	...
	public function __construct() {
		...
		require self::get_theme_path( $path . 'section-order/section-order.php' );
		require self::get_theme_path( $path . 'multi-select/multi-select.php' );
		require self::get_theme_path( $path . 'cat-dropdown/cat-dropdown.php' );
	}
	...
	public static function script() {
		...
		wp_localize_script(
			self::with_prefix( 'customize-js' ),
			'newslistColorPalette',
			array(
				'colorPalettes' => array(
					'#000000',
					'#ffffff',
...
new Newslist_Customizer_Loader();
