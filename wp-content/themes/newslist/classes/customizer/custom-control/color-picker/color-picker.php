...
if ( class_exists('WP_Customize_Control' ) ) {
	class Newslist_Customizer_Color_Control extends WP_Customize_Control {
...
newslist_Customizer::add_custom_control(array(
	'type'     => 'color-picker',
	'class'    => 'Newslist_Customizer_Color_Control',
	'sanitize' => array('Newslist_Customizer', 'sanitize_rgba'),
));
