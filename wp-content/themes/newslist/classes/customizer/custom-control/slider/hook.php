 ...
 */
if (!class_exists('Newslist_Customizer_Slider_Integration')) {
	class Newslist_Customizer_Slider_Integration extends Newslist_Customizer
	{
		...
		public static $class = 'Newslist_Customizer_Slider_Control';
	...
	new Newslist_Customizer_Slider_Integration();
}
