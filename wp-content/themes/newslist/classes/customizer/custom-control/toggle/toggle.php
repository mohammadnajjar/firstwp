...
/**
 * Customizer Control: newslist-toggle.
 *
 * @since 1.0.0
 *
 ...
 * @access public
 */
class Newslist_Toggle_Control extends WP_Customize_Control {
...
newslist_Customizer::add_custom_control(array(
	'type'     => 'toggle',
	'class'    => 'Newslist_Toggle_Control',
	'sanitize' => array( 'Newslist_Customizer', 'sanitize_checkbox' )
));
