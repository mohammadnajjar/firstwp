...
<section class="no-results not-found">
	...
	<header class="page-header">
		<h1 class="page-title"><?php esc_html_e('Nothing Found', 'newslist'); ?></h1>
	</header><!-- .page-header -->
	...
	<?php if (current_user_can('publish_posts')) : ?>
		<div class="page-content">
			...
			printf(
				...
				esc_html__('Sorry, but nothing matched your search terms. Please try again with some different keywords or you can add post.', 'newslist'),
				esc_url(admin_url('post-new.php')),
				esc_html__('Get Started Here', 'newslist')
			)
			?>
		</div><!-- .page-content -->
	<?php else : ?>
		<div class="page-content">
			...
			printf(
				'<p>%1$s</p> ',
				esc_html__('We can\'t seem to find any result that match your search key.', 'newslist'),
				esc_url(admin_url('post-new.php'))
			)
			?>
		</div><!-- .page-content -->
		<div>
			<a href="<?php echo esc_url(home_url('/')) ?>" class="newslist-btn-primary"><?php echo esc_html__('Go To Homepage', 'newslist') ?> <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
		</div>
	<?php endif; ?>
</section><!-- .no-results -->