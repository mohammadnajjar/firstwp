...
function morenews_get_default_theme_options() {
    ...
    $defaults['frontpage_sticky_sidebar_position'] = 'sidebar-sticky-bottom';
    ...
    $defaults['secondary_color']     = '#0098fe ';
    ...
    $defaults['main_navigation_badge_background']     = '#0098fe ';
    ...
    $defaults['category_color_1']    = '#0098fe ';
